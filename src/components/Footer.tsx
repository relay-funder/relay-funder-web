        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a
                href="https://t.me/relayfunder"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-surface-secondary hover:bg-accent/10 border border-border hover:border-accent/20 transition-all duration-200 group"
                aria-label="Join Relay Funder on Telegram"
              >
                <svg
                  className="w-5 h-5 text-text-muted group-hover:text-accent transition-colors duration-200"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
                  <path d="M9.78 18.65c-.41 0-.34-.15-.48-.53l-1.22-4.02 9.4-5.58" />
                  <path d="M9.78 18.65c.31 0 .45-.14.62-.31l1.71-1.66-2.13-1.28" />
                  <path d="M10 15.41 15.18 19c.59.33 1.01.16 1.16-.55l2.1-9.9c.22-.87-.33-1.26-.89-1.01L5.22 12.3c-.84.34-.83.81-.15 1.02l3.18.99 7.37-4.65c.35-.21.67-.1.41.13" />
                </svg>
              </a>
            </div>
          </div>
