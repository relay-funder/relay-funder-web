  ...
  const faqs = [
    {
      ...
      answer:
        'Relay Funder uses secure, audited digital infrastructure with privacy-preserving identity verification. Contributions are processed through trusted payment rails, converted into stablecoins (digital currencies tied to stable values like the US dollar), and sent directly to community treasuries.',
    },
    {
      question: 'Where do the funds actually go?',
      answer:
        'Funds go directly to vetted community treasuries in the regions where our partners on the ground operate.',
    },
    {
      question: 'Which regions does Relay Funder currently serve?',
      answer:
        'We currently serve refugee and displaced communities in Kenya and Uganda, with plans to expand across East Africa and other high-need regions in partnership with humanitarian organizations.',
    },
    {
      question: 'Who are Match Fund Sponsors and how do they work?',
      answer:
        'Match Fund Sponsors are individuals, foundations, NGOs, and philanthropies who contribute to the Match Fund, which amplifies individual contributions. The more community backers a project has, the larger the match it receives from the Sponsor pool.',
    },
    {
      question: 'How can campaigns apply to participate in match funds?',
      answer:
        'Campaign participation in match funds requires admin approval and depends on the specific topic and round sponsor requirements. Not every campaign is automatically eligible for every match fund - each round has its own focus areas and criteria set by the sponsoring organization. Interested organizations can contact our partnerships team to explore participation and review requirements.',
    },
    {
      question: 'When and how are match funds distributed to campaigns?',
      answer:
        'At the end of each campaign round, match funds are allocated based on transparent rules—for example, proportional to the number of unique contributions a campaign receives. Funds are then disbursed directly to the community treasury.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Community leaders provide updates and reporting, so donors can clearly see where funds went and what outcomes were achieved. We are working on on-chain impact verification, stay tuned!',
    },
  ];
      ...
      <section className="py-20 mesh-bg">
        <div className="max-w-content mx-auto px-6 text-center relative z-10">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-section-title text-text-primary mb-6">Still have questions?</h2>
            <p className="text-text-secondary mb-8">
              We're here to help. Reach out to learn more about how Relay Funder works or how you
              can get involved.
            </p>
            <a
