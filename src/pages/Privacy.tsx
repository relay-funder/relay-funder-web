      ...
      <section className="py-24 bg-surface">
        <div className="max-w-content mx-auto px-6 text-center">
          ...
          <p className="text-xl text-text-secondary max-w-3xl mx-auto leading-relaxed">
            We're committed to protecting your privacy and maintaining transparency about how we collect and use your information.
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-card border border-border rounded-xl p-8 mb-8">
              <h2 className="text-section-title text-text-primary mb-6">1. Information We Collect</h2>
              ...
              <h3 className="text-lg font-semibold text-text-primary mb-3">Information You Provide:</h3>
              ...
              <h3 className="text-lg font-semibold text-text-primary mb-3">Automatically Collected Information:</h3>
            ...
            <div className="bg-card border border-border rounded-xl p-8 mb-8">
              <h2 className="text-section-title text-text-primary mb-6">2. How We Use Your Information</h2>
              <p className="text-text-secondary leading-relaxed mb-4">
            ...
            <div className="bg-card border border-border rounded-xl p-8 mb-8">
              <h2 className="text-section-title text-text-primary mb-6">3. Information Sharing and Disclosure</h2>
              <p className="text-text-secondary leading-relaxed mb-4">
              ...
              <ul className="text-text-secondary space-y-2 ml-6 list-disc">
                ...
                <li><strong>Business Transfers:</strong> In connection with corporate transactions like mergers or acquisitions</li>
                <li><strong>With Consent:</strong> When you explicitly consent to information sharing</li>
              </ul>
            </div>

            <div className="bg-card border border-border rounded-xl p-8 mb-8">
              <h2 className="text-section-title text-text-primary mb-6">4. Data Security and Protection</h2>
              <p className="text-text-secondary leading-relaxed mb-4">
              ...
              <p className="text-text-secondary leading-relaxed mt-4">
                ...
                We cannot guarantee absolute security but commit to promptly addressing any security incidents.
              </p>
            </div>

            <div className="bg-card border border-border rounded-xl p-8 mb-8">
              <h2 className="text-section-title text-text-primary mb-6">5. Cookies and Tracking Technologies</h2>
              <p className="text-text-secondary leading-relaxed mb-4">
            ...
            <div className="bg-card border border-border rounded-xl p-8 mb-8">
              <h2 className="text-section-title text-text-primary mb-6">7. International Data Transfers</h2>
              <p className="text-text-secondary leading-relaxed">
                Our services may involve transferring your information across international borders. 
                We ensure appropriate safeguards are in place for international transfers, including 
                compliance with applicable data protection frameworks and contractual protections with service providers.
              </p>
            </div>
            ...
            <div className="bg-card border border-border rounded-xl p-8 mb-8">
              ...
              <p className="text-text-secondary leading-relaxed">
                ...
                comply with legal obligations, resolve disputes, and enforce agreements. When information is no longer needed, 
            ...
            <div className="bg-card border border-border rounded-xl p-8 mb-8">
              <h2 className="text-section-title text-text-primary mb-6">10. Changes to This Policy</h2>
              <p className="text-text-secondary leading-relaxed">
            ...
            <div className="bg-card border border-border rounded-xl p-8">
              ...
              <div className="mt-4 space-y-2 text-text-secondary">
                <p>Email: <a href="mailto:info@relayfunder.com" className="text-accent hover:underline">info@relayfunder.com</a></p>
              </div>
            </div>
